...
namespace Stetic.Widget {
	...
	[WidgetWrapper ("Message Dialog", "messagedialog.png")]
	public class MessageDialog : Gtk.Dialog, Stetic.IWindowWrapper {
		...
		static MessageDialog () {
			MessageDialogProperties = new PropertyGroup ("Message Dialog Properties",
								     typeof (Stetic.Widget.MessageDialog),
								     "Title",
								     "MessageType",
								     "PrimaryText",
								     "SecondaryText",
		...
		public MessageDialog (IStetic stetic) : base ()
		{
			Resizable = false;
			BorderWidth = 12;
